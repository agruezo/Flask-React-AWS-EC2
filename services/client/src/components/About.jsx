...
const About = () => (
    <div>
        ...
        <ul className="content">
            <li>
                Create a production Dockerfile that uses multistage Docker
                builds
            </li>
            <li>
                Utilize Amazon Elastic Container Registry (ECR) to store built
                images
            </li>
            <li>
        ...
        <ul className="content">
            ...
            <li>
                Configure an Application Load Balancer (ALB) along with ECS to
                run a set of microservices
            </li>
            <li>Send container logs to CloudWatch</li>
            <li>
                Update a running container via a zero-downtime deployment
                strategy to not disrupt the current users or application
            </li>
